...
export const DICT = {
  ...
  '전체 리포트 PDF': 'Full report PDF', '검수·매핑 포함': 'incl. review & mapping',
  '스펙시트 페이지를 찾지 못했습니다.': 'No spec-sheet pages found.',
  '인쇄': 'Print',
  ...
  '상단 우측 이동은 모델명 아래(제품 사진 옆) 빈 공간에 블록을 배치합니다.': 'Move to top right places the block in the empty space under the model name (next to the product photo).',
...
export const PATTERNS = [
  ...
  [/^남은 (OVERVIEW|DIMENSIONS) 블록 위치$/, 'Remaining $1 block position'],
